...
import com.rishva.roomdatabase_practiceapp.databinding.FragmentAddNoteBinding
...
class AddNoteFragment : Fragment(R.layout.fragment_add_note),MenuProvider {
    ...
    private fun saveNote(view: View){
        ...
        if(noteTitle.isNotEmpty()){
            ...
            Toast.makeText(addNoteView.context, "Note Saved Sucessufully", Toast.LENGTH_LONG).show()
