...
import com.rishva.roomdatabase_practiceapp.adapter.NoteAdapter
import com.rishva.roomdatabase_practiceapp.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment(R.layout.fragment_home),SearchView.OnQueryTextListener , MenuProvider {
    ...
    private fun upadteUi(note : List<Note>?){
